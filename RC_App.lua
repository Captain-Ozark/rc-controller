...
function setInfos()
  infos["tick"] = { x = 92, y = 28, width = 73, height= 1, title = "RF/Tick: ", unit = " RF"}
  infos["stored"] = { x = 92, y = 29, width = 73, height = 1, title = "Stored Energy: ", unit = " RF"}
  infos["rods"] = { x = 92, y = 30, width = 73, height= 1, title = "Control Rod Level: ", unit = "%"}
...
function getInfoFromReactor()
  ...
  reactor.stats["fuel_left"] = round(reactor.getFuelAmount(),2);
  reactor.stats["fuel_cap"] = round(reactor.getFuelAmountMax(),2);
